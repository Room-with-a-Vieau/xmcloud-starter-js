    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Content */}
          <div className="@container/herocontent @sm/herowrapper:px-5 @sm/herowrapper:pb-5 @md/herowrapper:px-10 @md/herowrapper:pb-10 @md/herowrapper:pt-20 @lg/herowrapper:px-24 @lg/herowrapper:pb-20 @lg/herowrapper:pt-36 relative z-10 mx-auto flex min-h-[420px] max-w-[1240px] flex-col justify-center pt-10 group-[.position-right]:items-end group-[.position-center]:items-center">
            {/* Title */}
            <AnimatedSection
              direction="up"
            ...
            >
              <Text
                tag="h1"
                field={title}
                className="font-heading text-box-trim-both-baseline @lg/herowrapper:p-0 text-shadow text-shadow-blur-xl @sm/herowrapper:text-shadow-blur-3xl @sm/herowrapper:px-0 relative -ml-[2px] max-w-[13ch] text-balance px-5 text-[clamp(2.5rem,7cqi,3.75rem)] font-bold leading-tight drop-shadow-[0_35px_35px_rgba(0,0,0,0.4)]"
              />
            </AnimatedSection>
            ...
            <AnimatedSection
              ...
              reducedMotion={prefersReducedMotion}
              delay={200}
              className="@sm/herowrapper:px-0 @md/herowrapper:mt-6 mt-4 px-5"
            >
              {description && (
                <Text
                  tag="p"
                  className="@xs/herocontent:text-xl @sm/herowrapper:px-0 text-shadow text-shadow-blur-xl max-w-[32ch] text-pretty leading-tight"
                  field={description}
                />
              )}
            </AnimatedSection>
